...
<table align="center" width="700" border="1">
	...
	<%
		...
		String str = "MemberView?reqname=showpost&postid=";
	%>
	<%
		for (int i = 0; i < len; i++) {
	%>
...
<span><a href="MemberView?reqname=firstpage">首页</a></span> <span><a
	href="MemberView?reqname=nextpage">下一页</a></span> <span><a
	href="MemberView?reqname=lastpage">上一页</a></span></p>
</body>
</html>